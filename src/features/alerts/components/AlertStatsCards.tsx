// src/features/alerts/components/AlertStatsCards.tsx
...
export const AlertStatsCards: React.FC<AlertStatsCardsProps> = ({ stats, loading }) => {
  ...
  const rateColor =
    successRate >= 90 ? 'bg-green-500 dark:bg-green-600'   :
    successRate >= 70 ? 'bg-amber-500 dark:bg-amber-600'   :
