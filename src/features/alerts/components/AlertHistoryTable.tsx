// src/features/alerts/components/AlertHistoryTable.tsx
...
const AlertHistoryFiltersBar: React.FC<AlertHistoryFiltersBarProps> = ({
  filters, onChange,
}) => {
  const inputClass =
    ...
    <div className="flex flex-wrap gap-3 items-end">
      ...
      <div className="flex flex-col gap-1">
        ...
        <select
          ...
          onChange={(e) =>
            onChange({ ...filters, status: (e.target.value as AlertStatus) || undefined })
          }
        >
        ...
        <Card variant="default" padding="lg">
          <div className="flex flex-col items-center justify-center py-12 text-text-secondary">
            ...
            <p className="text-xs mt-1 opacity-70">
              Gli alert inviati appariranno qui
            </p>
          </div>
        </Card>
      ) : (
