...
export const MODULES: ModuleConfig[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'notifiche', label: 'Notifiche', href: ROUTES.VEICOLI_NOTIFICHE },
      { id: 'audit', label: 'Audit interventi', href: ROUTES.VEICOLI_AUDIT },
      { id: 'log-email', label: 'Log email', href: ROUTES.VEICOLI_LOG_EMAIL },
