      ...
      <div className="w-full px-4 py-2">
        <div className="flex flex-col sm:flex-row justify-between items-center space-y-2 sm:space-y-0">
          ...
          <div className="flex flex-wrap justify-center sm:justify-end items-center space-x-4 text-xs">
            <a href="/privacy" className="text-text-secondary hover:text-violet-500 transition-colors">
              Privacy
            </a>
            <a href="/terms" className="text-text-secondary hover:text-violet-500 transition-colors">
              Termini
            </a>
            <a href="/support" className="text-text-secondary hover:text-violet-500 transition-colors">
              Supporto
            </a>
