    ...
    <div className='min-h-full flex items-center justify-center p-4'>
      <div className='max-w-lg w-full'>
        ...
        <div className='mb-8 text-center'>
          ...
          <h2 className='text-3xl font-bold mb-4 text-text-primary'>Pagina non trovata</h2>
          <p className='text-lg text-text-secondary'>La pagina che stai cercando non esiste o è stata spostata.</p>
        </div>
        ...
        <div className='space-y-4 mb-8'>
          <div className='flex flex-col sm:flex-row gap-3 justify-center'>
            ...
            <Link to={ROUTES.DASHBOARD} className='flex-shrink-0'>
              <div className='inline-flex items-center px-6 py-3 rounded-lg font-medium transition-all duration-200 hover:bg-violet-700 focus:ring-2 focus:ring-violet-500 focus:ring-offset-2 w-full sm:w-auto justify-center bg-bg-contrast text-text-contrast'>
